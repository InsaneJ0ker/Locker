...
def storedata():
    ...
    if len(appName) == 0 or len(password) == 0:
        messagebox.showinfo( message="Please make sure that each and every field is filled up")
...
# Input Info
websiteURL = Label(text="Website: ",background='#172b3f', foreground='#42c1b6')
...
# Buttons
generatePassword = Button(text="Generate",width=14, command=passwordGenerator, background='#42c1b6', foreground='#172b3f',highlightthickness=0, bd=0)
generatePassword.grid(row=3, column=2, padx=3)
add = Button(text="Add", width=29, command=storedata, background='#42c1b6', foreground='#172b3f', highlightthickness=0, bd=0)
add.grid(row=4, column=1, pady=5)
search = Button(text="Search", width=14, command=search, background='#42c1b6', foreground='#172b3f', highlightthickness=0, bd=0)
search.grid(row=4, column=2)
delete = Button(text="Delete", width=29, command=delete, background='#42c1b6', foreground='#172b3f', highlightthickness=0, bd=0)
